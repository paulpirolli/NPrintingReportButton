define( ["qlik", "text!./template.html","css!./styles.css"],
	function ( qlik, template ) {
		var hostURLName = location.origin;
		...
		return {
			...
			controller: ['$scope', function ( $scope ) {
				...
				NPrintButton.onclick = function retrieveReport(){ $.ajax({
					...
					//url: "https://ec2-34-225-54-124.compute-1.amazonaws.com/qrs/sharedcontent/full?xrfkey=GAMG717cpRsrx7xR&filter=owner.name eq 'ppirolli'",//&filter=name
